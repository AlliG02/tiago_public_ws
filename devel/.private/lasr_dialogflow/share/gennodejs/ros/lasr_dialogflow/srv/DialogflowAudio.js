...
class DialogflowAudioRequest {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type DialogflowAudioRequest
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type DialogflowAudioRequest
    let len;
    let data = new DialogflowAudioRequest(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new DialogflowAudioRequest(null);
...
class DialogflowAudioResponse {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type DialogflowAudioResponse
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type DialogflowAudioResponse
    let len;
    let data = new DialogflowAudioResponse(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new DialogflowAudioResponse(null);
