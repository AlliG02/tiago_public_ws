...
// (in-package lasr_dialogflow.srv)
...
class DialogflowTextRequest {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type DialogflowTextRequest
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type DialogflowTextRequest
    let len;
    let data = new DialogflowTextRequest(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new DialogflowTextRequest(null);
...
class DialogflowTextResponse {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type DialogflowTextResponse
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type DialogflowTextResponse
    let len;
    let data = new DialogflowTextResponse(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new DialogflowTextResponse(null);
