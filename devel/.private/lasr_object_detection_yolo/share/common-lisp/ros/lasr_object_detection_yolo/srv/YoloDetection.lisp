...
(cl:in-package lasr_object_detection_yolo-srv)
...
(cl:defmethod cl:initialize-instance :after ((m <YoloDetection-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'YoloDetection-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name lasr_object_detection_yolo-srv:<YoloDetection-request> is deprecated: use lasr_object_detection_yolo-srv:YoloDetection-request instead.")))

(cl:ensure-generic-function 'image_raw-val :lambda-list '(m))
(cl:defmethod image_raw-val ((m <YoloDetection-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader lasr_object_detection_yolo-srv:image_raw-val is deprecated.  Use lasr_object_detection_yolo-srv:image_raw instead.")
  (image_raw m))

(cl:ensure-generic-function 'dataset-val :lambda-list '(m))
(cl:defmethod dataset-val ((m <YoloDetection-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader lasr_object_detection_yolo-srv:dataset-val is deprecated.  Use lasr_object_detection_yolo-srv:dataset instead.")
  (dataset m))

(cl:ensure-generic-function 'confidence-val :lambda-list '(m))
(cl:defmethod confidence-val ((m <YoloDetection-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader lasr_object_detection_yolo-srv:confidence-val is deprecated.  Use lasr_object_detection_yolo-srv:confidence instead.")
  (confidence m))

(cl:ensure-generic-function 'nms-val :lambda-list '(m))
(cl:defmethod nms-val ((m <YoloDetection-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader lasr_object_detection_yolo-srv:nms-val is deprecated.  Use lasr_object_detection_yolo-srv:nms instead.")
  (nms m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<YoloDetection-request>)))
  ...
  "lasr_object_detection_yolo/YoloDetectionRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'YoloDetection-request)))
  "Returns string type for a service object of type 'YoloDetection-request"
  "lasr_object_detection_yolo/YoloDetectionRequest")
...
(cl:defmethod cl:initialize-instance :after ((m <YoloDetection-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'YoloDetection-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name lasr_object_detection_yolo-srv:<YoloDetection-response> is deprecated: use lasr_object_detection_yolo-srv:YoloDetection-response instead.")))

(cl:ensure-generic-function 'detected_objects-val :lambda-list '(m))
(cl:defmethod detected_objects-val ((m <YoloDetection-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader lasr_object_detection_yolo-srv:detected_objects-val is deprecated.  Use lasr_object_detection_yolo-srv:detected_objects instead.")
  (detected_objects m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<YoloDetection-response>)))
  ...
  "lasr_object_detection_yolo/YoloDetectionResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'YoloDetection-response)))
  "Returns string type for a service object of type 'YoloDetection-response"
  "lasr_object_detection_yolo/YoloDetectionResponse")
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'YoloDetection)))
  ...
  "lasr_object_detection_yolo/YoloDetection")