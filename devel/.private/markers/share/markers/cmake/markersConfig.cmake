...
if("TRUE" STREQUAL "TRUE")
  set(markers_SOURCE_PREFIX /home/k21066336/tiago_public_ws/src/legacy/markers)
  set(markers_DEVEL_PREFIX /home/k21066336/tiago_public_ws/devel/.private/markers)
  set(markers_INSTALL_PREFIX "")
  set(markers_PREFIX ${markers_DEVEL_PREFIX})
else()
  set(markers_SOURCE_PREFIX "")
  set(markers_DEVEL_PREFIX "")
  set(markers_INSTALL_PREFIX /home/k21066336/tiago_public_ws/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'markers' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/k21066336/tiago_public_ws/src/legacy/markers/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/k21066336/tiago_public_ws/devel/.private/markers/lib;/home/k21066336/tiago_public_ws/devel/lib;/overlay_ws/devel/lib;/opt/tiago_public_ws/devel/lib;/opt/ros/noetic/lib)
