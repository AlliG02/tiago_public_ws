...
class SegmentBBRequest {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type SegmentBBRequest
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type SegmentBBRequest
    let len;
    let data = new SegmentBBRequest(null);
  ...
  static datatype() {
    ...
    return 'pcl_segmentation/SegmentBBRequest';
  }

  static md5sum() {
    //Returns md5sum for a message object
    return '1ed8e93d11d1bf90e53fd300811c9e7c';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new SegmentBBRequest(null);
...
class SegmentBBResponse {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type SegmentBBResponse
    // Serialize message field [points]
    bufferOffset = sensor_msgs.msg.PointCloud2.serialize(obj.points, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type SegmentBBResponse
    let len;
    let data = new SegmentBBResponse(null);
    // Deserialize message field [points]
    data.points = sensor_msgs.msg.PointCloud2.deserialize(buffer, bufferOffset);
    return data;
  }
  ...
  static datatype() {
    // Returns string type for a service object
    return 'pcl_segmentation/SegmentBBResponse';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new SegmentBBResponse(null);
    if (msg.points !== undefined) {
      resolved.points = sensor_msgs.msg.PointCloud2.Resolve(msg.points)
    }
    else {
...
module.exports = {
  Request: SegmentBBRequest,
  Response: SegmentBBResponse,
  md5sum() { return 'f0ea1be981fddc86e1e6ea80904f27b1'; },
  datatype() { return 'pcl_segmentation/SegmentBB'; }
};
