...
(cl:defmethod cl:initialize-instance :after ((m <TfTransform-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'TfTransform-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name tf_module-srv:<TfTransform-request> is deprecated: use tf_module-srv:TfTransform-request instead.")))

(cl:ensure-generic-function 'pose_array-val :lambda-list '(m))
(cl:defmethod pose_array-val ((m <TfTransform-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader tf_module-srv:pose_array-val is deprecated.  Use tf_module-srv:pose_array instead.")
  (pose_array m))

(cl:ensure-generic-function 'pointcloud-val :lambda-list '(m))
(cl:defmethod pointcloud-val ((m <TfTransform-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader tf_module-srv:pointcloud-val is deprecated.  Use tf_module-srv:pointcloud instead.")
  (pointcloud m))

(cl:ensure-generic-function 'point-val :lambda-list '(m))
(cl:defmethod point-val ((m <TfTransform-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader tf_module-srv:point-val is deprecated.  Use tf_module-srv:point instead.")
  (point m))
...
(cl:defmethod source_frame-val ((m <TfTransform-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader tf_module-srv:source_frame-val is deprecated.  Use tf_module-srv:source_frame instead.")
  (source_frame m))
(cl:defmethod roslisp-msg-protocol:serialize ((msg <TfTransform-request>) ostream)
  ...
  (roslisp-msg-protocol:serialize (cl:slot-value msg 'source_frame) ostream)
)
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <TfTransform-request>) istream)
  ...
  (roslisp-msg-protocol:deserialize (cl:slot-value msg 'source_frame) istream)
  msg
)
...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<TfTransform-request>)))
  ...
  "e3031e602aea7b277ed3e5a9a7804b9a")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'TfTransform-request)))
  "Returns md5sum for a message object of type 'TfTransform-request"
  "e3031e602aea7b277ed3e5a9a7804b9a")
...
(cl:defmethod roslisp-msg-protocol:serialization-length ((msg <TfTransform-request>))
  (cl:+ 0
     ...
     (roslisp-msg-protocol:serialization-length (cl:slot-value msg 'source_frame))
))
...
(cl:defclass <TfTransform-response> (roslisp-msg-protocol:ros-message)
  ((target_pose_array
   ...
   (translation_and_rotation
    :reader translation_and_rotation
    :initarg :translation_and_rotation
...
(cl:defmethod cl:initialize-instance :after ((m <TfTransform-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'TfTransform-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name tf_module-srv:<TfTransform-response> is deprecated: use tf_module-srv:TfTransform-response instead.")))

(cl:ensure-generic-function 'target_pose_array-val :lambda-list '(m))
(cl:defmethod target_pose_array-val ((m <TfTransform-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader tf_module-srv:target_pose_array-val is deprecated.  Use tf_module-srv:target_pose_array instead.")
  (target_pose_array m))

(cl:ensure-generic-function 'target_pointcloud-val :lambda-list '(m))
(cl:defmethod target_pointcloud-val ((m <TfTransform-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader tf_module-srv:target_pointcloud-val is deprecated.  Use tf_module-srv:target_pointcloud instead.")
  (target_pointcloud m))

(cl:ensure-generic-function 'target_point-val :lambda-list '(m))
(cl:defmethod target_point-val ((m <TfTransform-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader tf_module-srv:target_point-val is deprecated.  Use tf_module-srv:target_point instead.")
  (target_point m))

(cl:ensure-generic-function 'translation_and_rotation-val :lambda-list '(m))
(cl:defmethod translation_and_rotation-val ((m <TfTransform-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader tf_module-srv:translation_and_rotation-val is deprecated.  Use tf_module-srv:translation_and_rotation instead.")
  (translation_and_rotation m))
(cl:defmethod roslisp-msg-protocol:serialize ((msg <TfTransform-response>) ostream)
  ...
  (roslisp-msg-protocol:serialize (cl:slot-value msg 'translation_and_rotation) ostream)
)
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <TfTransform-response>) istream)
  ...
  (roslisp-msg-protocol:deserialize (cl:slot-value msg 'translation_and_rotation) istream)
  msg
)
...
(cl:defmethod roslisp-msg-protocol:serialization-length ((msg <TfTransform-response>))
  (cl:+ 0
     ...
     (roslisp-msg-protocol:serialization-length (cl:slot-value msg 'translation_and_rotation))
))
(cl:defmethod roslisp-msg-protocol:ros-message-to-list ((msg <TfTransform-response>))
  ...
  (cl:list 'TfTransform-response
    ...
    (cl:cons ':translation_and_rotation (translation_and_rotation msg))
))
